...
REPROCESSING_STAGE_SPECS = (
    ...
    StageSpec(
        name="09_timeline",
        stage_version="1.6.0",
        dependencies=("03_keyframes", "08_captions", "08_ocr"),
        required_inputs=(
            "scenes",
            "keyframes",
            "embedded_text",
...
def create_reprocessing_registry() -> StageRegistry:
    """Return the six-Stage query-guided derived-run registry."""

    return StageRegistry(
        REPROCESSING_STAGE_SPECS,
        external_inputs=REPROCESSING_EXTERNAL_INPUTS,
    )
